...
public class DatabaseReader extends ConnectorClass
{
    ...
    public final String DATABASE_USE_TRANSACTIONS = "transaction";
    ...
    public Properties getProperties()
    {
        ...
        if(useTransactionsNo.isSelected())
            properties.put(DATABASE_USE_TRANSACTIONS, "false");
        else
            properties.put(DATABASE_USE_TRANSACTIONS, "true");
    ...
    public void setProperties(Properties props)
    {
        ...
        if(((String)props.get(DATABASE_USE_TRANSACTIONS)).equalsIgnoreCase("false"))
            useTransactionsNo.setSelected(true);
        else
            useTransactionsYes.setSelected(true);
    }
    ...
    private void initComponents()
    {
        ...
        useTransactionsButtonGroup = new javax.swing.ButtonGroup();
        ...
        useTransactionsYes = new com.webreach.mirth.client.ui.components.MirthRadioButton();
        useTransactionsNo = new com.webreach.mirth.client.ui.components.MirthRadioButton();
        ...
        jLabel10.setText("Use Transactions:");

        useTransactionsYes.setBackground(new java.awt.Color(255, 255, 255));
        useTransactionsYes.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        useTransactionsButtonGroup.add(useTransactionsYes);
        useTransactionsYes.setText("Yes");
        useTransactionsYes.setMargin(new java.awt.Insets(0, 0, 0, 0));

        useTransactionsNo.setBackground(new java.awt.Color(255, 255, 255));
        useTransactionsNo.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        useTransactionsButtonGroup.add(useTransactionsNo);
        useTransactionsNo.setSelected(true);
        useTransactionsNo.setText("No");
        useTransactionsNo.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        .add(layout.createSequentialGroup()
                            .add(useTransactionsYes, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(useTransactionsNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jScrollPane3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private javax.swing.ButtonGroup useTransactionsButtonGroup;
    private com.webreach.mirth.client.ui.components.MirthRadioButton useTransactionsNo;
    private com.webreach.mirth.client.ui.components.MirthRadioButton useTransactionsYes;
