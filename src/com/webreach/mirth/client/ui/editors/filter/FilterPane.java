...
public class FilterPane extends JPanel {	
   ...
   public FilterPane( Frame p, Filter t ) {
    ...
    public void initComponents() {
        ...
        // 		rulePanel.addCard(blankPanel, blankPanel.getType());
        ...
        filterTaskPaneContainer.add(viewPane);
    ...
    public void makeFilterTable() {
        ...
        String[] comboBoxValues = new String[] { "NONE", "AND", "OR" };
        ...
        filterTable.getColumnExt( RULE_OP_COL ).setMaxWidth( 80 );
        filterTable.getColumnExt( RULE_OP_COL ).setMinWidth( 80 );
    ...
    private void FilterListSelected( ListSelectionEvent evt ) {
        ...
        if( isValid( row ) ) { 
        	//String operator = (String)filterTable.getValueAt( row, RULE_OP_COL );
    ...
    private void saveData() {
    	...
    	/* I shouldn't really have to do any of this...
    	if ( isValid( prevSelectedRow ) ) {
        	String operator = (String)
        			filterTable.getValueAt( prevSelectedRow, RULE_OP_COL );
        	String script = (String)
        			filterTable.getValueAt( prevSelectedRow, RULE_SCRIPT_COL );
    	
	    	// save the data to the the most recently selected Rule
	    	if ( script != null ) {
	    		filterTableModel.setValueAt( operator, prevSelectedRow, RULE_OP_COL );
	    		filterTableModel.setValueAt( script, prevSelectedRow, RULE_SCRIPT_COL );
	    	}
    	}*/
